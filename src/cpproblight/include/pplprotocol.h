...
#ifndef FLATBUFFERS_GENERATED_PPLPROTOCOL_PPLPROTOCOL_H_
#define FLATBUFFERS_GENERATED_PPLPROTOCOL_PPLPROTOCOL_H_
...
enum Distribution {
  ...
  Distribution_MAX = Distribution_Uniform
};

inline Distribution (&EnumValuesDistribution())[3] {
...
inline flatbuffers::Offset<ProtocolTensor> CreateProtocolTensorDirect(
  ...
  return PPLProtocol::CreateProtocolTensor(
      _fbb,
...
inline const PPLProtocol::Message *GetMessage(const void *buf) {
  return flatbuffers::GetRoot<PPLProtocol::Message>(buf);
}
...
inline bool VerifyMessageBuffer(
  ...
  return verifier.VerifyBuffer<PPLProtocol::Message>(MessageIdentifier());
}

inline void FinishMessageBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<PPLProtocol::Message> root) {
  fbb.Finish(root, MessageIdentifier());
}

}  // namespace PPLProtocol

#endif  // FLATBUFFERS_GENERATED_PPLPROTOCOL_PPLPROTOCOL_H_
